...
public class Master 
{
    ...
    static void reporta()
    {
        try
        {
          ...
          System.out.println(" tiempo total: " + -servDisparo.deltaTEnMilis());
          System.out.println("media de tiempo de ciclo:" + servDisparo.deltaTmedia() + " milisegundos");
          System.out.println(" dev std tiempo de ciclo:" + servDisparo.deltaTStdDev()+ " milisegundos");
          System.out.println("  tiempo de ciclo máximo:" + servDisparo.deltaTMax()+ " milisegundos");
          System.out.println("  tiempo de ciclo mínimo:" + servDisparo.deltTMin()+ " milisegundos");
        }
        catch( Exception e )
        {
            e.printStackTrace();
